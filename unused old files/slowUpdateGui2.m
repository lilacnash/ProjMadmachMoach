function varargout = slowUpdateGui2(varargin)
% SLOWUPDATEGUI2 MATLAB code for slowUpdateGui2.fig
% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @slowUpdateGui2_OpeningFcn, ...
                   'gui_OutputFcn',  @slowUpdateGui2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before slowUpdateGui2 is made visible.
function slowUpdateGui2_OpeningFcn(hObject, eventdata, handles, varargin)
% Choose default command line output for slowUpdateGui2
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes slowUpdateGui2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = slowUpdateGui2_OutputFcn(hObject, eventdata, handles) 
