...
%                 Position_PopUpMenu = [0.02+(width*i)+POP_UP_MENU_WIDTH*(i-1),0.95-height*(j),POP_UP_MENU_WIDTH,POP_UP_MENU_HEIGHT];
                ...
                handlesGUI.fastPlotTitle(n) = uicontrol('Style', 'text', 'Units','normalized', 'Position', titlePosition, 'Tag', ['fastPlotTitle',num2str(n)],'String','aaaaaaaaaa', 'FontSize', TEXT_FONT_SIZE);
                n = n+1;                     
            end   
        end
    end
